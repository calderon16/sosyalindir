...
/**
 * SosyalIndir Ana Sayfası (Çoklu Dil Desteği)
 */
    ...
    "@graph": [
      {
        ...
        "description": locale === "en"
          ...
          : "Instagram Reels, TikTok ve Facebook Reels videolarını filigransız, hızlı ve %100 ücretsiz orijinal kalitede indirin.",
  ...
  return (
    <div className="w-full py-12 md:py-20 px-4 sm:px-6 flex flex-col items-center justify-center">
      ...
      <div className="max-w-4xl mx-auto text-center space-y-6">
        ...
        {/* Trust Badges (Page UI Leading Pill Deseni - 3 Rozet) */}
        <div className="pt-2">
          <TrustBadges />
        </div>
        ...
        <div className="pt-2 flex flex-col items-center gap-3">
          <p className="text-xs font-medium text-slate-400 flex items-center justify-center gap-1.5 flex-wrap">
            <span>{tHero("supportedPlatforms")}</span>
          </p>
          ...
          <div className="flex items-center justify-center gap-4 text-slate-500 text-xs">
            ...
            <div className="flex items-center gap-1.5 hover:text-red-400 transition-colors">
              ...
              <span>Shorts ({locale === "en" ? "Soon" : "Yakında"})</span>
            </div>
        ...
        <div className="pt-16 grid grid-cols-1 sm:grid-cols-3 gap-6 max-w-3xl mx-auto text-left">
          <div className="p-5 rounded-2xl bg-slate-900/50 border border-slate-800/80 space-y-2">
            ...
            <h3 className="text-sm font-bold text-white">{tFeatures("instantTitle")}</h3>
            <p className="text-xs text-slate-400">{tFeatures("instantDesc")}</p>
          </div>

          <div className="p-5 rounded-2xl bg-slate-900/50 border border-slate-800/80 space-y-2">
            <Sparkles className="w-6 h-6 text-emerald-400" />
            <h3 className="text-sm font-bold text-white">{tFeatures("noWatermarkTitle")}</h3>
            <p className="text-xs text-slate-400">{tFeatures("noWatermarkDesc")}</p>
          </div>

          <div className="p-5 rounded-2xl bg-slate-900/50 border border-slate-800/80 space-y-2">
            <ShieldCheck className="w-6 h-6 text-emerald-400" />
            <h3 className="text-sm font-bold text-white">{tFeatures("secureTitle")}</h3>
            <p className="text-xs text-slate-400">{tFeatures("secureDesc")}</p>
          </div>
        </div>
